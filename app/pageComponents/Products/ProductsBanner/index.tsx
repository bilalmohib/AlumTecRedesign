const ProductsBanner = () => {
  return (
    <div className="bg-[url('/Images/Products/banner.jxr')] h-[81vh] mt-[105px] w-full bg-cover bg-no-repeat bg-center">
      <div className="relative h-[79.5vh] w-full backdrop-filter backdrop-blur-0 ease-linear transition">
